#!/nix/store/qwg7nqq0y2lzc94pdaa00li2z12h4jl4-bash-5.2p37/bin/bash
...
main() {
	...
	if is_osx && command_exists "/nix/store/yimdjx8bd6pxx2d1vyalf6cj52pivd43-reattach-to-user-namespace-2.9/bin/reattach-to-user-namespace" && option_value_not_changed "default-command" ""; then
		tmux set-option -g default-command "/nix/store/yimdjx8bd6pxx2d1vyalf6cj52pivd43-reattach-to-user-namespace-2.9/bin/reattach-to-user-namespace -l $SHELL"
	fi
